...
Purpose:
  ...
  2. Execute AMS simulation (xrun -f xrunArgs) inside sim_TOP_cosim_python_A1.
  3. Keep PSF database in sim_TOP_cosim_python_A1/psf.
...
class OneTestRunner:
    ...
    def run_simulation(self):
        ...
        # Sync PSF results into local sim_TOP_cosim_python_A1/psf
    ...
    def evaluate_results(self):
        ...
        report = {
            "test_summary": "OneTest Calibration & Trim Verification (sim_TOP_cosim_python_A1)",
            "tester_mode": "sim",
            "items": {
                "101": {
